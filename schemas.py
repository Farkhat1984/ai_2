...
from functions import (
    ...
    find_apartments_by_district, contact_to_owner
)
...
def run_conversation(user_id, content):
    ...
    tools = [
        ...
        },
        {
            "type": "function",
            "function": {
                "name": "contact_to_owner",
                "description": "Send a message to the owner",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "agreement": {"type": "boolean", "description": "user agreement to send message to owner"},
                        "text":{"type": "string", "description":"assistant have to ask user to write this command {/contact_to_owner}"}
                    },
    ...
    if response and response.choices:
        ...
        if tool_calls:
            available_functions = {
                ...
                "contact_to_owner": contact_to_owner,
            }
